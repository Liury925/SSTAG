...
from datasets_process.data import TAGData, TAGDataset, BaseDict
from utils.dataset_split import generate_link_split
...
class Pubmed(TAGDataset):
    ...
    def download(self) -> None:
        download_hf_file(HF_REPO_ID, subfolder="Pubmed", filename="pubmed.pt", cache_dir=self.raw_dir, local_dir=self.raw_dir)
        download_hf_file(HF_REPO_ID, subfolder="Pubmed", filename="pubmed.json", cache_dir=self.raw_dir, local_dir=self.raw_dir)
