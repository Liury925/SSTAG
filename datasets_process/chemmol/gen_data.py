...
from datasets_process.data import TAGData, BaseDict
...
def get_atomic_name_dict(raw_dir):
    file_path = osp.join(raw_dir, "id2element.csv")
...
def get_raw_dataset(name, raw_dir):
    print("gen text")
    data = load_dataset("./TAGDataset/chembl/molecule_property_instruction", split=NAME_TO_SPLIT[name], )
